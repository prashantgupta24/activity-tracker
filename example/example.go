...
func main() {
	...
	heartbeatCh := activityTracker.StartWithHandlers(handler.MachineSleepHandler(), handler.MouseClickHandler(),
		handler.MouseCursorHandler(), handler.ScreenChangeHandler())
